...
fun main(args: Array<String>) {
    ...
    when (day) {
        ...
        25 -> {
            println("Solution for day $day, task 1: " + day25.Task.solvePart1(DEFAULT_INPUT_FILENAME))
            println("Solution for day $day, task 2: " + day25.Task.solvePart2(DEFAULT_INPUT_FILENAME))
        }
